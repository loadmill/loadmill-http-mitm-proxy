...
var ServerAttrs = [{
  ...
  shortName: 'OU',
  value: 'Loadmill MITM Proxy Server Certificate'
}];
...
CA.prototype.generateCA = function (callback) {
  ...
  pki.rsa.generateKeyPair({bits: 2048}, function(err, keys) {
    ...
    cert.validity.notAfter.setDate(cert.validity.notAfter.getDate() - 2);
...
CA.prototype.generateServerCertificateKeys = function (hosts, cb) {
  ...
  certServer.validity.notAfter.setDate(certServer.validity.notAfter.getDate() - 2);
